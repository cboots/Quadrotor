...
U 1 1 58B89232
P 2400 2800
F 0 "#PWR17" H 1100 750 50  0001 C CNN
...
U 1 1 58B892B4
P 4300 2800
F 0 "#PWR18" H 3000 750 50  0001 C CNN
...
U 1 1 58B8B12B
P 10250 6200
F 0 "#PWR29" H 8950 4150 50  0001 C CNN
...
U 1 1 58B8B57E
P 10850 5700
F 0 "#PWR33" H 10900 5750 50  0001 C CNN
...
U 1 1 58BA68B9
P 1350 7600
F 0 "#PWR7" H 1350 7350 50  0001 C CNN
...
U 1 1 58B7BFAA
P 5800 1300
F 0 "#PWR25" H 4500 -750 50  0001 C CNN
...
U 1 1 58B7C131
P 6200 1300
F 0 "#PWR27" H 4900 -750 50  0001 C CNN
...
U 1 1 58B7D83B
P 5300 1400
F 0 "#PWR23" H 4000 -650 50  0001 C CNN
...
U 1 1 58B7D876
P 5100 1400
F 0 "#PWR22" H 3800 -650 50  0001 C CNN
...
U 1 1 58B7D8B1
P 4900 1400
F 0 "#PWR21" H 3600 -650 50  0001 C CNN
...
U 1 1 58B7D8EC
P 4700 1400
F 0 "#PWR20" H 3400 -650 50  0001 C CNN
...
U 1 1 58B7D927
P 4500 1400
F 0 "#PWR19" H 3200 -650 50  0001 C CNN
...
U 1 1 58B82BC8
P 1150 2100
F 0 "#PWR6" H -150 50  50  0001 C CNN
...
U 1 1 58B82D5B
P 1400 2100
F 0 "#PWR8" H 100 50  50  0001 C CNN
...
U 1 1 58B8358A
P 2300 1400
F 0 "#PWR16" H 1000 -650 50  0001 C CNN
...
U 1 1 58B83590
P 2100 1400
F 0 "#PWR14" H 800 -650 50  0001 C CNN
...
U 1 1 58B83596
P 1900 1400
F 0 "#PWR13" H 600 -650 50  0001 C CNN
...
U 1 1 58B8359C
P 1700 1400
F 0 "#PWR12" H 400 -650 50  0001 C CNN
...
U 1 1 58B835A2
P 1500 1400
F 0 "#PWR9" H 200 -650 50  0001 C CNN
...
U 1 1 58B86F94
P 1150 1300
F 0 "#PWR5" H -150 -750 50  0001 C CNN
...
U 1 1 58B86FE5
P 850 1300
F 0 "#PWR3" H -450 -750 50  0001 C CNN
...
U 1 1 58B8A103
P 5300 1900
F 0 "#PWR24" H 4000 -150 50  0001 C CNN
...
U 1 1 58B8D10C
P 10850 4850
F 0 "#PWR32" H 9150 2350 50  0001 C CNN
...
U 1 1 58B8E11D
P 9750 5350
F 0 "#PWR28" H 8450 3300 50  0001 C CNN
...
U 1 1 58B9C26A
P 1600 1900
F 0 "#PWR10" H -100 -600 50  0001 C CNN
...
U 1 1 58B9C685
P 1600 2200
F 0 "#PWR11" H 300 150 50  0001 C CNN
...
U 1 1 58C25D91
P 2150 2800
F 0 "#PWR15" H 2200 2850 50  0001 C CNN
...
U 1 1 58DCF8B0
P 10850 3600
F 0 "#PWR30" H 9800 700 50  0001 C CNN
